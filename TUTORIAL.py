...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.wasd2 = arcade.Sprite("wasd2.png", 4.2)
        self.wasd2.center_x = 450
        self.wasd2.center_y = 250
        self.wall_list.append(self.wasd2)


        self.player_sprite = arcade.Sprite("ice.png")
        ...
        # background.
        for x in range(-128, 900, 128):
            for y in range(-128, 500, 128):
